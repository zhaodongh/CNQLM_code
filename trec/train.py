...
def test_point_wise():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default(), open(precision, "w") as log:
            ...
            writer = tf.summary.FileWriter("logs_NNQLM2_embedding_xiangwei_uniform/", sess.graph)
            ...
            for i in range(FLAGS.num_epochs):
                ...
                for data in datas:
                    ...
                    _, step, loss, accuracy, pred, scores,input_y,position,rs= sess.run(
                        [train_op, global_step, cnn.loss, cnn.accuracy,cnn.predictions, cnn.scores,cnn.input_y,cnn.embedding_W_complex,merged],feed_dict)
